...
namespace Dorobantu_Andreea_Lab2.Data
{
    public class Dorobantu_Andreea_Lab2Context : DbContext
    {
        ...
        public DbSet<Dorobantu_Andreea_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Dorobantu_Andreea_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
